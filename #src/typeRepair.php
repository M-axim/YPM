...
<head>
    ...
    <title>Предоставляемые типы ремонтов</title>
</head>
        ...
        <div class="main__body _container">
            ...
            <div class="main__top top-main">
                ...
                <div class="top-main__view">
                    <h2 class="top-main__title" data-header="top-main__header">Предоставляемые типы ремонтов</h2>
                </div>

            </div>

            <?php include "pages-blocks/typeRepair.php"?>
