...
<head>
    ...
    <title>Информация об производителях</title>
</head>
        ...
        <div class="main__body _container">
            ...
            <div class="main__top top-main">
                ...
                <div class="top-main__view">
                    <h2 class="top-main__title" data-header="top-main__header">Информация об производителях</h2>
                </div>

            </div>

            <?php include "pages-blocks/countries.php"?>
